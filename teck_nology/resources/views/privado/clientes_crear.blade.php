        ...
        <main class="main-content">
            ...
            <section class="seccion_inventario">
                <div class="form-crear">
                    ...
                    <form action="{{ route('clientes.store') }}" method="POST" class="form-usuario" data-ajax="clientes">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" id="telefono" name="telefono" value="{{ old('telefono') }}" class="input-text">
                        </div>

                        <div class="form-row">
                            <label for="direccion">Dirección</label>
                            <input type="text" id="direccion" name="direccion" value="{{ old('direccion') }}" class="input-text">
                        </div>
