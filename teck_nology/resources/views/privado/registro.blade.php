        ...
        <div class="card" style="max-width:700px;margin:20px auto;padding:20px;background:#fff;border-radius:8px;">
          <form action="{{ route('registro.post') }}" method="POST" class="form-grid">
            ...
            <div class="form-row form-actions" style="grid-column:1/-1;display:flex;gap:12px;justify-content:flex-end;">
              <a href="{{ url('/login') }}" class="boton-cancelar btn-admin btn-ghost" style="align-self:center;padding:8px 12px;background:#f3f3f3;border-radius:6px;text-decoration:none;color:#333;">Volver</a>
              <button type="submit" class="boton-guardar btn-admin" style="padding:8px 16px;background:#1e8f4a;color:#fff;border-radius:6px;border:none;">Crear cuenta</button>
            </div>
